...
class BaseBlock extends SpriteComponent with HasGameRef<PixelAdventure> {
  final String id;
  BaseBlock({
    required this.id,
  ...
  FutureOr<void> onLoad() {
    ...
    sprite = Sprite(
      image,
      srcPosition: Vector2(8 * 36, 8 * 18), // where it starts in the sheet
      srcSize: Vector2(8 * 4, 8 * 4), // size of the block
    );
    debugMode = false;
